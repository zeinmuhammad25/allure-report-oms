...
test.describe.serial("Tools", () => {
    ...
    test("[TC_0205783] Validate Logic when User can sort Descending Created By in Branch Event List sub-tab menu on Tools",
        {tag: tags + "@positive"}, async ({tools, branchEventList}, testInfo) => {
            await safeTest(async ({}) => {
                await tools.selectTab(ToolsTabs.BranchEventList);
                await branchEventList.clickButtonFilterDate();
                ...
                await branchEventList.datePickerMonth("SEP");
                await branchEventList.datePickerDate("1");
                await branchEventList.shortingDescBranchEventList("Created By");
                await branchEventList.dataValidation("DEV1RIZAL");
            }, {tools, branchEventList}, testInfo);
        });

    test("[TC_0205784] Validate Logic when User can open Detail Branch Event in Branch Event List sub-tab menu on Tools",
        {tag: tags + "@positive"}, async ({tools, branchEventList}, testInfo) => {
            await safeTest(async ({}) => {
                await tools.selectTab(ToolsTabs.BranchEventList);
                await branchEventList.clickButtonFilterDate();
    ...
    test("[TC_0205786] Validate Logic when User can navigate to the Next Page in Branch Event List sub-tab menu on Tools",
        {tag: tags + "@positive"}, async ({tools, branchEventList}, testInfo) => {
            await safeTest(async ({}) => {
                await tools.selectTab(ToolsTabs.BranchEventList);
                await branchEventList.clickButtonFilterDate();
                ...
                await branchEventList.datePickerMonth("SEP");
                await branchEventList.datePickerDate("1");
                await branchEventList.depositPagination("next");
                await branchEventList.depositPagination("next");
                await branchEventList.dataValidation("Push Data");
            }, {tools, branchEventList}, testInfo);
        });

    test("[TC_0205787] Validate Logic when User can navigate to the Previous Page in Branch Event List sub-tab menu on Tools",
        {tag: tags + "@positive"}, async ({tools, branchEventList}, testInfo) => {
            await safeTest(async ({}) => {
                await tools.selectTab(ToolsTabs.BranchEventList);
                await branchEventList.clickButtonFilterDate();
                ...
                await branchEventList.depositPagination("next");
                await branchEventList.depositPagination("next");
                await branchEventList.depositPagination("previous");
                await branchEventList.depositPagination("previous");
                await branchEventList.dataValidation("DEV1RIZAL");
            }, {tools, branchEventList}, testInfo);
        });

    test("[TC_0205788] Validate Logic when User can navigate to the Last Page in Branch Event List sub-tab menu on Tools",
        {tag: tags + "@positive"}, async ({tools, branchEventList}, testInfo) => {
            await safeTest(async ({}) => {
                await tools.selectTab(ToolsTabs.BranchEventList);
                await branchEventList.clickButtonFilterDate();
