...
test.describe.serial("Promotion Inclusive After Discount", () => {
    ...
    test("[TC_0205482] Validate Logic When User Apply Promotion Head Then Cancel 1 Menu - Order Pages - Menu Discount Rp All Category",
        {tag: tags + "@negative"}, async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, promotionList}, testInfo) => {
            await safeTest(async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, promotionList}) => {
                await makeOrder("AT INCLUSIVE", bookOrder, quickServiceList);
                await order.selectCategoryMenu(MenuList.atCategory.name);
    ...
    test("[TC_0205483] Validate Logic When User Apply Promotion Head Then Cancel 1 Menu - Order Pages - Menu Discount Rp Menu",
        {tag: tags + "@negative"}, async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, promotionList}, testInfo) => {
            await safeTest(async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, promotionList}) => {
                await makeOrder("AT INCLUSIVE", bookOrder, quickServiceList);
                await order.selectCategoryMenu(MenuList.atCategory.name);
    ...
    test("[TC_0205484] Validate Logic When User Apply Promotion Head Then Cancel 1 Menu - Order Pages - Menu Discount Rp Menu Category",
        {tag: tags + "@negative"}, async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, promotionList}, testInfo) => {
            await safeTest(async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, promotionList}) => {
                await makeOrder("AT INCLUSIVE", bookOrder, quickServiceList);
                await order.selectCategoryMenu(MenuList.atCategory.name);
    ...
    test("[TC_0205485] Validate Logic When User Apply Promotion Head Then Cancel 1 Menu - Order Pages - Menu Discount Rp Menu Category Detail",
        {tag: tags + "@negative"}, async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, promotionList}, testInfo) => {
            await safeTest(async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, promotionList}) => {
                await makeOrder("AT INCLUSIVE", bookOrder, quickServiceList);
                await order.selectCategoryMenu(MenuList.atCategory.name);
    ...
    test("[TC_0205488] Validate Logic When User Apply Promotion Head Then Cancel 1 Menu - Order Pages - FREE ITEM ALL CATEGORY",
    ...
    test("[TC_0205489] Validate Logic When User Apply Promotion Head Then Cancel 1 Menu - Order Pages - FREE ITEM MENU CATEGORY",
        {tag: tags + "@negative"}, async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, editOrderV2}, testInfo) => {
            await safeTest(async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, editOrderV2}) => {
                await makeOrder("AT INCLUSIVE", bookOrder, quickServiceList);
                await order.selectCategoryMenu(MenuList.atCategory.name);
    ...
    test("[TC_0205491] Validate Logic When User Apply Promotion Head Then Cancel 1 Menu - Order Pages - FREE ITEM MENU",
        {tag: tags + "@negative"}, async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, editOrderV2}, testInfo) => {
            await safeTest(async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, editOrderV2}) => {
                await makeOrder("AT INCLUSIVE", bookOrder, quickServiceList);
                await order.selectCategoryMenu(MenuList.atCategory.name);
