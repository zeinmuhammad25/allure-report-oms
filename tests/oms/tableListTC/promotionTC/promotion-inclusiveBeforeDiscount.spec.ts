...
test.describe("Promotion Inclusive Before Discount", () => {
    ...
    test("[TC_0205407] Validate Logic When User Apply Promotion Head - Payment Pages -  Discount % Menu Category",
        {tag: tags + "@positive"}, async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, promotionList}, testInfo) => {
            await safeTest(async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, promotionList}) => {
                await makeOrder("AT INCLUSIVE", bookOrder, quickServiceList);
                await order.selectCategoryMenu(MenuList.atCategory.name);
    ...
    test("[TC_0205408] Validate Logic When User Apply Promotion Head - Payment Pages -  Discount % Menu Category Detail",
        {tag: tags + "@positive"}, async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, promotionList}, testInfo) => {
            await safeTest(async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, promotionList}) => {
                await makeOrder("AT INCLUSIVE", bookOrder, quickServiceList);
                await order.selectCategoryMenu(MenuList.atCategory.name);
    ...
    test("[TC_0205409] Validate Logic When User Apply Promotion Head - Payment Pages -  Discount Limit % Menu",
        {tag: tags + "@positive"}, async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, promotionList}, testInfo) => {
            await safeTest(async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, promotionList}) => {
                await makeOrder("AT INCLUSIVE", bookOrder, quickServiceList);
                await order.selectCategoryMenu(MenuList.atCategory.name);
    ...
    test("[TC_0205410] Validate Logic When User Apply Promotion Head - Payment Pages -  Discount Limit % Menu Category",
        {tag: tags + "@positive"}, async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, promotionList}, testInfo) => {
            await safeTest(async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, promotionList}) => {
                await makeOrder("AT INCLUSIVE", bookOrder, quickServiceList);
                await order.selectCategoryMenu(MenuList.atCategory.name);
    ...
    test("[TC_0205411] Validate Logic When User Apply Promotion Head - Payment Pages -  Discount Limit % Menu Category Detail",
        {tag: tags + "@positive"}, async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, promotionList}, testInfo) => {
            await safeTest(async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, promotionList}) => {
                await makeOrder("AT INCLUSIVE", bookOrder, quickServiceList);
                await order.selectCategoryMenu(MenuList.atCategory.name);
    ...
    test("[TC_0205412] Validate Logic When User Apply Promotion Head - Payment Pages - Menu Discount Rp All Category",
        {tag: tags + "@positive"}, async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, promotionList}, testInfo) => {
            await safeTest(async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, promotionList}) => {
                await makeOrder("AT INCLUSIVE", bookOrder, quickServiceList);
                await order.selectCategoryMenu(MenuList.atCategory.name);
    ...
    test("[TC_0205413] Validate Logic When User Apply Promotion Head - Payment Pages -  Menu Discount Rp Menu",
        {tag: tags + "@positive"}, async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, promotionList}, testInfo) => {
            await safeTest(async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, promotionList}) => {
                await makeOrder("AT INCLUSIVE", bookOrder, quickServiceList);
                await order.selectCategoryMenu(MenuList.atCategory.name);
    ...
    test("[TC_0205414] Validate Logic When User Apply Promotion Head - Payment Pages -  Menu Discount Rp Menu Category",
        {tag: tags + "@positive"}, async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, promotionList}, testInfo) => {
            await safeTest(async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, promotionList}) => {
                await makeOrder("AT INCLUSIVE", bookOrder, quickServiceList);
                await order.selectCategoryMenu(MenuList.atCategory.name);
    ...
    test("[TC_0205415] Validate Logic When User Apply Promotion Head - Payment Pages -  Menu Discount Rp Menu Category Detail",
        {tag: tags + "@positive"}, async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, promotionList}, testInfo) => {
            await safeTest(async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, promotionList}) => {
                await makeOrder("AT INCLUSIVE", bookOrder, quickServiceList);
                await order.selectCategoryMenu(MenuList.atCategory.name);
    ...
    test("[TC_0205416] Validate Logic When User Apply Promotion Head - Payment Pages -  Open Bill Dicount Rp",
        {tag: tags + "@positive"}, async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, promotionList}, testInfo) => {
            await safeTest(async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, promotionList}) => {
                await makeOrder("AT INCLUSIVE", bookOrder, quickServiceList);
                await order.selectCategoryMenu(MenuList.atCategory.name);
    ...
    test("[TC_0205417] Validate Logic When User Apply Promotion Head - Payment Pages -  Open Bill Dicount %",
        {tag: tags + "@positive"}, async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, promotionList}, testInfo) => {
            await safeTest(async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, promotionList}) => {
                await makeOrder("AT INCLUSIVE", bookOrder, quickServiceList);
                await order.selectCategoryMenu(MenuList.atCategory.name);
    ...
    test("[TC_0205418] Validate Logic When User Apply Promotion - Apply All Qty - FREE ITEM ALL CATEGORY",
    ...
    test("[TC_0205419] Validate Logic When User Apply Promotion - Apply All Qty - FREE ITEM MENU CATEGORY",
        {tag: tags + "@positive"}, async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, editOrderV2}, testInfo) => {
            await safeTest(async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, editOrderV2}) => {
                await makeOrder("AT INCLUSIVE", bookOrder, quickServiceList);
                await order.selectCategoryMenu(MenuList.atCategory.name);
    ...
    test("[TC_0205421] Validate Logic When User Apply Promotion - Apply All Qty - FREE ITEM MENU",
        {tag: tags + "@positive"}, async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, editOrderV2}, testInfo) => {
            await safeTest(async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, editOrderV2}) => {
                await makeOrder("AT INCLUSIVE", bookOrder, quickServiceList);
                await order.selectCategoryMenu(MenuList.atCategory.name);
    ...
    test("[TC_0205434] Validate Logic When User Apply Promotion Head Then Cancel 1 Menu - Order Pages - Open Bill Dicount Rp",
        {tag: tags + "@negative"}, async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, promotionList}, testInfo) => {
            await safeTest(async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, promotionList}) => {
                await makeOrder("AT INCLUSIVE", bookOrder, quickServiceList);
                await order.selectCategoryMenu(MenuList.atCategory.name);
                ...
                await addOrderV2.addToCartMenuDetailPackage();
                await order.selectCategoryDetailMenu(MenuList.atCategory.atMenuPaket.name);
                await orderSingleMenu(order,10,10,9)
                await order.deleteMenu(MenuList.atCategory.atMenuBiasa.atMenuBiasaGoreng.name);
                await order.addPromotion();
                await promotionList.searchPromotion("OPEN BILL DISCOUNT RP");
    ...
    test("[TC_0205435] Validate Logic When User Apply Promotion Head Then Cancel Order - Order Pages - Open Bill Dicount %",
        {tag: tags + "@negative"}, async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, promotionList}, testInfo) => {
            await safeTest(async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, promotionList}) => {
                await makeOrder("AT INCLUSIVE", bookOrder, quickServiceList);
                await order.selectCategoryMenu(MenuList.atCategory.name);
    ...
    test("[TC_0205436] Validate Logic When User Apply Promotion Head Then Cancel 1 Menu - Order Pages - FREE ITEM ALL CATEGORY",
    ...
    test("[TC_0205439] Validate Logic When User Apply Promotion Head Then Cancel 1 Menu - Order Pages - FREE ITEM MENU",
        {tag: tags + "@negative"}, async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, editOrderV2}, testInfo) => {
            await safeTest(async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, editOrderV2}) => {
                await makeOrder("AT INCLUSIVE", bookOrder, quickServiceList);
                await order.selectCategoryMenu(MenuList.atCategory.name);
    ...
    test("[TC_0205440] Validate Logic When User Apply Promotion Head - Order Pages - BUY X GET FREE Y",
        {tag: tags + "@positive"}, async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, promotionList}, testInfo) => {
            await safeTest(async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, promotionList}) => {
                await makeOrder("AT INCLUSIVE", bookOrder, quickServiceList);
                await order.selectCategoryMenu(MenuList.atCategory.name);
    ...
    test("[TC_0205441] Validate Logic When User Apply Promotion Head - Order Pages - BUY X GET FREE Y Category",
        {tag: tags + "@positive"}, async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, promotionList}, testInfo) => {
            await safeTest(async ({quickServiceList, bookOrder, order, addOrderV2, paymentV2, promotionList}) => {
                await makeOrder("AT INCLUSIVE", bookOrder, quickServiceList);
                await order.selectCategoryMenu(MenuList.atCategory.name);
