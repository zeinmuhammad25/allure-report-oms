...
test.describe.serial("Dine in Merge Table", () => {
    ...
    test.beforeEach(async ({terminalID, signPin, tableList, order, sideNavBar}) => {
        const testWithAuthentication = [
            ...
            "[TC_0205168] Validate Logic when User can Merge Table with emptied table after Hold All menu"
        ];
    ...
    test("[TC_0205166] Validate Logic when User can Merge Table with filled table after Hold menu",
