...
export default class BranchTabTransactionLocator extends BaseLocator {
    ...
    //toggle
    static branchToggleOtherTax: string = "//nz-form-control//nz-switch[@id='flagOtherTaxVat']";
    ...
    static branchRadioBtnRoundingYes: string = "//label[span[text()=' Ya ']]/span/input";
    ...
    //button
    static branchTransactionButtonAddPayment: string = "//button[normalize-space()='Tambah']";
    static branchTransactionButtonActivate: string = "//button[normalize-space()='Aktifkan']";
    static branchTransactionButtonSave: string = "//button[@class='button button-orange button-small ng-star-inserted']";
    static branchTransactionButtonCancel: string = "//button[@class='button button-outline-red button-small ng-star-inserted']";
