...
import BranchPage from "../branchSetting/branch/branch.page";
import BrandPage from "../branchSetting/brand/brand.page";
import CompanyPage from "../branchSetting/company/company.page";
import GenerateOTPPage from "../branchSetting/generateOTP/generateOTP.page";
import NotificationEmailPage from "../branchSetting/notificationEmail/notificationEmail.page";
import PaymentMethodPage from "../branchSetting/paymentMethod/paymentMethod.page";
import TableSettingPage from "../branchSetting/tableSetting/tableSetting.page";
