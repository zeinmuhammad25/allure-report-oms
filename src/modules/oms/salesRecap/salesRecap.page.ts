...
export default class SalesRecapPage extends BaseOmsPage implements SalesRecapScenario {
    ...
    async shortingDescOnlinePayment(headerName: "Transaction Time" | "Order ID" | "Sales Number"
        | "Payment Method" | "Payment Status" | "Transaction Amount"): Promise<void> {
        await this.expectVisible(SalesRecapLocator.headersOnlinePayment(headerName));
        await this.click(SalesRecapLocator.headersOnlinePayment(headerName));
        await this.click(SalesRecapLocator.headersOnlinePayment(headerName));
    ...
    async paginationOnlinePaymentBackNext(type: "left" | "right"): Promise<void> {
        await this.expectVisible(SalesRecapLocator.paginationOnlinePaymentNextBack(type));
        await this.click(SalesRecapLocator.paginationOnlinePaymentNextBack(type));
    }

    async paginationOnlinePaymentFirstLast(type: "left" | "right"): Promise<void> {
        await this.expectVisible(SalesRecapLocator.paginationOnlinePaymentFirstLast(type));
