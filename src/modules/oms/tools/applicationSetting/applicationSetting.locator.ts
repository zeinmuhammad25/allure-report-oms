...
export default class ApplicationSettingLocator extends BaseLocator {
    ...
    static qrCodeDropdown: string = `(//div[@class='mat-select-arrow-wrapper'])[2]`;
    ...
    static selectSalesModeForDineIn = (SelectDineInSalesMode: string): string =>
        `//div[contains(@class,'mat-select-panel')]//mat-option[.//span[normalize-space()='${SelectDineInSalesMode}']]`;
    static showQuickServiceMode: string = "(//div[@class='mat-select-arrow-wrapper'])[4]";
    static selectSalesModeForQuickService = (SelectQuickServiceSalesMode: string): string =>
        `//div[contains(@class,'mat-select-panel')]//mat-option[.//span[normalize-space()='${SelectQuickServiceSalesMode}']]`;
    ...
    static selectSalesModeForDefaultQS = (SelectDineInSalesMode: string): string =>
        `//div[contains(@class,'mat-select-panel')]//mat-option[.//span[normalize-space()='${SelectDineInSalesMode}']]`;
    ...
    static CustomerDisplayLength: string = `//div[label[normalize-space()='Pole Display Length']]//app-number-input//input[@matkeyboard='numpad']`;
    static CustomerDisplayport: string = `//div[label[normalize-space()='Pole Display Port']]//input[@name='poleDisplayPort']`;
    ...
    static checkboxSelfOrderServer: string = "(//label//div[contains(@class,'mat-checkbox-inner-container')])[2]";
    static dropDownSelfOrderServer: string = "(//div[@class='mat-select-arrow-wrapper'])[7]";
    static selectESBOrderPrinterStation = (SelectEsoStation: string): string =>
        `//div[contains(@class,'mat-select-panel')]//mat-option[.//span[normalize-space()='${SelectEsoStation}']]`;
    static turnOffServer: string = "//button[.//span[normalize-space()='Turn Off Server']]";
    static cancelTurnOffServer: string = "//button[.//span[normalize-space()='Cancel']]";
