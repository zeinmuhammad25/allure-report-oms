...
export default class PaymentLocator extends BaseLocator {
    ...
    static payButton: string = "//button[contains(@id,'p-payment')]";
    ...
    static onlinePaymentButton: string = "(//button[contains(@class,'payment-method-tab epayment')])[1]";
    static offlinePaymentButton: string = "(//button[contains(@class,'payment-method-tab epayment')])[2]";
